...
// Split out of checkout/success/page.tsx (Sep 8, 2026 technical-SEO pass,
// Section 15): page.tsx needs to be a Server Component to export a
// server-rendered noindex robots tag. Same content, same logic — only the
// file changed.
