...
// Shared table-of-contents data drives both the desktop sticky sidebar and
// the mobile collapsible menu from one source (Section 7 of the Sep 2026
// Terms rebuild explicitly asks for this — no duplicated section lists).
// Desktop: a lightweight IntersectionObserver-based scroll-spy highlights
// the section currently in view; mobile: a real disclosure <button> with
// aria-expanded/aria-controls, closes on Escape or on picking a link,
// mirroring the accessible-accordion pattern already used by SellFaq.tsx.
